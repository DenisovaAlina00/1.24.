# 2.24.номер3. вариант 2.24. Составить программу:а)вычислления значения функции х=√2а+sin|3a|/2,56 при любом значении а; б) вычисления значения функции у=sin3,2+√1=x/|5x| при любом значении х.
